...
<fieldset>
  ...
  <div id="datepicker" class="form-group date">
    ...
    <div class="col-sm-6">
      {{Form::text('birth_date', null, array('id'=>'birth_date', 'class' => 'form-control','readonly','style'=>'cursor:pointer;'))}}
    </div>
  </div>
  <div class="form-group">
    {{Form::label('country','Country', array('class'=>'col-md-3 control-label text-right'))}}
    <div class="col-sm-6">
      <select name="country" class="form-control col-md-4">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      ...
      <table>
        <tr>
          <td>
            {{Form::select('credit_card_valid_month', $months, null, array('class'=>'form-control '))}}
          </td>
          <td>&nbsp</td>
          <td>
            {{Form::select('credit_card_valid_year', $years, null, array('class'=>'form-control '))}}
          </td>
        </tr>
