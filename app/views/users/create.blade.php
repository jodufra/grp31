            ...
            <fieldset>
                    ...
                    <div class="col-md-6">
                        ...
                        <div ng-controller="CountriesController" ng-init="selected = ''">
                            <select name="country" class="form-control col-md-4" required>
                                <option ng-repeat="country in countries()" ng-selected="selected == country"
                                        value="[[country]]" title="[[country]]" ng-bind="country"></option>
                            </select>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        {{Form::text('phone', null,array('class' => 'form-control', 'style' => 'margin-top: 5px;'))}}
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <table>
                            <tr>
                                ...
                                <td><img height="46px" width="63px" src="{{asset('img/visa.png')}}" alt="VISA"
                                         title="VISA"></td>
                                <td>{{Form::radio('credit_card_type', 'Mastercard', false, array('class' => ''));}}</td>
                                <td><img height="46px" width="63px" src="{{asset('img/master.png')}}" alt="MasterCard"
                                         title="MasterCard"></td>
                                <td>{{Form::radio('credit_card_type', 'American Express', false, array('class' => ''));}}</td>
                                <td><img height="46px" width="63px" src="{{asset('img/amex.png')}}"
                                         alt="American Express" title="American Express"></td>
                            </tr>
                        </table>
                    </div>
                </div>
